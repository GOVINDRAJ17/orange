...
const ChartTooltipContent = React.forwardRef((props, ref) => {
  ...
  const tooltipLabel = React.useMemo(() => {
    ...
    const value = !labelKey && typeof label === "string" ? (config && config[label])?.label || label : itemConfig && itemConfig.label;
...
function getPayloadConfigFromPayload(config, payload, key) {
  ...
  return config && config[configLabelKey] ? config[configLabelKey] : config && config[key];
}
